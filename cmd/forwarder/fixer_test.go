...
func TestFixWithLogAuthUser(t *testing.T) {
	var output = [][]byte{
		[]byte("107 <13>1 2013-06-07T13:17:49.468822+00:00 host heroku web.7 - [origin ip=\"1.2.3.4\"][log_iss_user=\"ingest\"] hi\n110 <13>1 2013-06-07T13:17:49.468822+00:00 host heroku web.7 - [origin ip=\"1.2.3.4\"][log_iss_user=\"ingest\"] hello\n"),
		[]byte("150 <13>1 2013-06-07T13:17:49.468822+00:00 host heroku web.7 - [origin ip=\"1.2.3.4\"][log_iss_user=\"ingest\"][meta sequenceId=\"hello\"][foo bar=\"baz\"] hello\n"),
		[]byte("110 <13>1 2013-06-07T13:17:49.468822+00:00 host heroku web.7 - [origin ip=\"1.2.3.4\"][log_iss_user=\"ingest\"] hello\n"),
		[]byte("103 <13>1 2013-06-07T13:17:49.468822+00:00 host heroku web.7 - [origin ip=\"1.2.3.4\"][log_iss_user=\"ingest\"]"),
		[]byte("141 <13>1 2013-06-07T13:17:49.468822+00:00 host heroku web.7 - [origin ip=\"1.2.3.4\"][log_iss_user=\"ingest\"][60607e20-f12d-483e-aa89-ffaf954e7527]"),
	}
	for x, in := range input {
